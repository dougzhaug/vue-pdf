        ...
        <div class="weui-cells weui-cells_form">
            <div class="weui-cell weui-cell_select weui-cell_select-before">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" v-model="phone" key="phone" type="tel" pattern="[0-9]*" placeholder="请输入号码"/>
                </div>
            </div>
            ...
            <div class="weui-cell weui-cell_vcode">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" v-model="captcha" key="captcha" type="number" pattern="[0-9]*" placeholder="请输入验证码"/>
                </div>
        ...
        methods:{
            ...
            sendCaptcha(){
                ...
                if(this.phone === '' || this.phone === undefined){
                    this.$weui.alert('请输入手机号码!');
                    return false;
                }
                if (!(/^1[3456789]\d{9}$/.test(this.phone))) {
                    this.$weui.alert('请输入正确的手机号码!');
                    return false;
                }
            ...
            login(){
                ...
                if(this.captcha.length !== 6){
                    this.$weui.alert('验证码位数错误');
                    return false;
                }

                Login(this.phone,this.captcha).then((response)=>{
